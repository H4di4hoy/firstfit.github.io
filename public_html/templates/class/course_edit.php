<?php include_once "templates/include/header.php" ?>
  ...
  <?php
  // getting the id of the passed id into this page using Get variable.
  $id = isset( $_GET['id'] ) ? $_GET['id'] : "";
  $data=Course::getById($id);
  ?>

      <h4 class="w-100 text-center border border-info rounded m-0 p-3 bg-warning">EDIT FORM</h4>
      <fieldset>
        <!--Perform the relevant action in the header to update the class details, posts to admin.php-->
